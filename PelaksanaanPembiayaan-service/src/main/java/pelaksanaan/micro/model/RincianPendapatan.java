...
public class RincianPendapatan {
    ...
    public RincianPendapatan(ObyekPendapatan obypendapatan, Long id, Long norut, String uraian, Long jumlah, String satuan, Long hs, String sumberdana, Long jumtot) {
